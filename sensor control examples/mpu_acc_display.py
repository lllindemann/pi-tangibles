...
while True:
    # read vector3 value of accelerometer (m/s^2)
    ax, ay, az = mpu.acceleration

    # render black background (rectancle with full display size)
    draw.rectangle((0, 0, disp.width, disp.height), fill=(0, 0, 0))

    # render three text lines, every line shows one dimension of the accelerometer value
